...
class tcp_sink : public my_spdlog::sinks::base_sink<Mutex> {
public:
...
protected:
    void sink_it_(const my_spdlog::details::log_msg &msg) override {
        my_spdlog::memory_buf_t formatted;
        my_spdlog::sinks::base_sink<Mutex>::formatter_->format(msg, formatted);
...
using tcp_sink_st = tcp_sink<my_spdlog::details::null_mutex>;
