...
TEST_CASE("stdout_st", "[stdout]") {
    auto l = my_spdlog::stdout_logger_st("test");
    l->set_pattern("%+");
    l->set_level(my_spdlog::level::trace);
    l->trace("Test stdout_st");
    my_spdlog::drop_all();
}

TEST_CASE("stdout_mt", "[stdout]") {
    auto l = my_spdlog::stdout_logger_mt("test");
    l->set_pattern("%+");
    l->set_level(my_spdlog::level::debug);
    l->debug("Test stdout_mt");
    my_spdlog::drop_all();
}

TEST_CASE("stderr_st", "[stderr]") {
    auto l = my_spdlog::stderr_logger_st("test");
    l->set_pattern("%+");
...
TEST_CASE("stderr_mt", "[stderr]") {
    auto l = my_spdlog::stderr_logger_mt("test");
    l->set_pattern("%+");
...
TEST_CASE("stdout_color_st", "[stdout]") {
    auto l = my_spdlog::stdout_color_st("test");
    l->set_pattern("%+");
...
TEST_CASE("stdout_color_mt", "[stdout]") {
    auto l = my_spdlog::stdout_color_mt("test");
    l->set_pattern("%+");
    l->set_level(my_spdlog::level::trace);
...
TEST_CASE("stderr_color_st", "[stderr]") {
    auto l = my_spdlog::stderr_color_st("test");
    l->set_pattern("%+");
    l->set_level(my_spdlog::level::debug);
...
TEST_CASE("stderr_color_mt", "[stderr]") {
    auto l = my_spdlog::stderr_color_mt("test");
    l->set_pattern("%+");
...
TEST_CASE("wchar_api", "[stdout]") {
    auto l = my_spdlog::stdout_logger_st("wchar_logger");
    l->set_pattern("%+");
    l->set_level(my_spdlog::level::trace);
