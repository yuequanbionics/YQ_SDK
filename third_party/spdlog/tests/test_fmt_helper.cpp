...
void test_pad2(int n, const char *expected) {
    memory_buf_t buf;
    my_spdlog::details::fmt_helper::pad2(n, buf);
...
void test_pad3(uint32_t n, const char *expected) {
    memory_buf_t buf;
    my_spdlog::details::fmt_helper::pad3(n, buf);
...
void test_pad6(std::size_t n, const char *expected) {
    memory_buf_t buf;
    my_spdlog::details::fmt_helper::pad6(n, buf);
...
void test_pad9(std::size_t n, const char *expected) {
    memory_buf_t buf;
    my_spdlog::details::fmt_helper::pad9(n, buf);
