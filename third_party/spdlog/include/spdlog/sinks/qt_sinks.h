// Copyright(c) 2015-present, Gabi Melman, mguludag and my_spdlog contributors.
...
// Color location is determined by the sink log pattern like in the rest of my_spdlog sinks.
