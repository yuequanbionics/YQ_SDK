...
enum Command : uint8_t
{
    ...
    CMD_SET_CUR_VALUE = 0x1C,     // 电流控制
    CMD_SET_VEL_VALUE = 0x1D,     // 速度控制
...
public:
    ...
    */
     ...
     * @param Rad 位置值，单位度
     * @param Speed_Rad_S 速度值，单位度/秒
     * @param Force_N 力矩值，单位牛米
     * @param P_N_Rad 位置环KP（无效）
     * @param D_N_Rad_s 位置环KD（无效）
    */
